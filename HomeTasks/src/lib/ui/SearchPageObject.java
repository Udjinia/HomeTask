...
public class SearchPageObject extends MainPageObject
{
    private static final String
            ...
            SEARCH_INIT_FIELD ="org.wikipedia:id/menu_page_search",
            SEARCH_INPUT="//*[contains(@text,'Search…')]",
            SEARCH_CANCEL_BUTTON="org.wikipedia:id/search_close_btn",
            SEARCH_RESULT_BY_SUBSTRING_TPL ="//*[@resource-id ='org.wikipedia:id/page_list_item_container']//*[@text='{SUBSTRING}']",
            SEARCH_RESULT_ELEMENT="//*[@resource-id='org.wikipedia:id/search_results_list']/*[@resource-id='org.wikipedia:id/page_list_item_container']",
            SEARCH_EMPTY_RESULT="//*[@text='No results found']",
            SEARCH_DEFAULT_START_TEXT="//*[@text='Search and read the free encyclopedia in your language']";
    ...
    {
        this.waitForElementAndClick(By.id(SEARCH_INIT_FIELD),"Cannot find and click search button in article",5);
    ...
    {
        waitForElementPresent(By.xpath(SEARCH_DEFAULT_START_TEXT),"Default text for starting search is not presented",15);
    }
}
